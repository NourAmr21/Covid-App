...
public class EditPhoto extends AppCompatActivity {
  ...
  //  ActivityMainBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  image=(ImageView)findViewById(R.id.firebaseimage) ;
        ...
        storageReference.putFile(imageUri)
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(EditPhoto.this,"Successfully Uploaded",Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                if (progressDialog.isShowing())
                    progressDialog.dismiss();
                Toast.makeText(EditPhoto.this,"Failed to Upload",Toast.LENGTH_SHORT).show();
